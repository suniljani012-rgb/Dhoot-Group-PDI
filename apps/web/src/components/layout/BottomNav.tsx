...
import { LayoutDashboard, Car, CheckSquare, Wrench, ShieldCheck } from 'lucide-react';
...
export const BottomNav: React.FC = () => {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 h-16 bg-white/95 backdrop-blur-lg border-t border-[#E2E8F0] px-2 flex items-center justify-around z-30 shadow-[0_-4px_20px_rgba(0,0,0,0.05)] safe-area-bottom">
